...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("c8a3ee62", content, true, context)
};
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".specification{max-height:350px;overflow-y:auto}/deep/ .get-btn{right:5px!important}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/coupon/components/index.vue?vue&type=template&id=2271cf7e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div"+(_vm._ssrClass("cu-modal bottom-modal",_vm.modalShow?'show':''))+">","</div>",[_vm._ssrNode("<div class=\"cu-dialog\">","</div>",[_vm._ssrNode("<div class=\"cu-bar bg-white\"><div class=\"action\"></div> <div class=\"action text-blue\">取消</div></div> "),_vm._ssrNode("<div class=\"padding-xl bg-white text-left\">","</div>",[_vm._ssrNode("<div>领券</div> "),_vm._l((_vm.getLists),function(item,index){return _c('coolc-coupon',{key:index,attrs:{"item":item,"theme":"#ff6c00","color":"#ffffff","solid":"#ff6c00"},on:{"getCoupon":_vm.getCoupon}})})],2)],2)])])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/user/coupon/components/index.vue?vue&type=template&id=2271cf7e&

// EXTERNAL MODULE: ./pages/user/coupon/components/coolc-coupon.vue + 4 modules
var coolc_coupon = __webpack_require__(323);

// EXTERNAL MODULE: ./api/coupon.js
var coupon = __webpack_require__(177);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/coupon/components/index.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var componentsvue_type_script_lang_js_ = ({
  ...
  components: {
    coolcCoupon: coolc_coupon["default"]
  },
  ...
  methods: {
    ...
    getCoupon(item) {
      const that = this;
      Object(coupon["a" /* create */])(item, function (res) {
...
// CONCATENATED MODULE: ./pages/user/coupon/components/index.vue?vue&type=script&lang=js&
 /* harmony default export */ var coupon_componentsvue_type_script_lang_js_ = (componentsvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/user/coupon/components/index.vue
