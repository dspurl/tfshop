...
export default class TextPathElement extends TextElement {
    ...
    protected pathM(pathParser: PathParser, points: number[]): any;
    protected pathL(pathParser: PathParser, points: number[]): any;
    protected pathH(pathParser: PathParser, points: number[]): any;
    protected pathV(pathParser: PathParser, points: number[]): any;
    protected pathC(pathParser: PathParser, points: number[]): void;
    protected pathS(pathParser: PathParser, points: number[]): any;
    protected pathQ(pathParser: PathParser, points: number[]): void;
    protected pathT(pathParser: PathParser, points: number[]): any;
    protected pathA(pathParser: PathParser): any[];
...
export {};
//# sourceMappingURL=TextPathElement copy.d.ts.map