...
return [
    ...
    */
    'admin' => [
        ...
        'adminView' => '查看管理员',
        'adminDestroy' => '删除管理员',
        'adminFilterList' => '管理员过滤器列表',
        'adminFilterCreate' => '创建管理员过滤器',
        'adminFilterEdit' => '保存管理员过滤器',
        'adminFilterDestroy' => '删除管理员过滤器',
        'adminLog' => '管理员日志',
        'adminLogView' => '查看管理员',
        'userList' => '会员列表',
        'userCreate' => '创建会员',
        ...
        'resourceGroups' => '资源设置分组',
        'resourceDestroy' => '删除资源',
        'resourceGroupList' => '资源分组列表',
        'resourceGroupCreate' => '创建资源分组',
        'resourceGroupView' => '查看资源分组',
        'resourceGroupEdit' => '保存资源分组',
        'resourceGroupSort' => '资源分组排序',
        'resourceGroupDestroy' => '删除资源分组',
        'resourceType' => '资源类型',
        'resourceTypeCreate' => '创建资源类型',
        'resourceTypeView' => '查看资源类型',
        'resourceTypeEdit' => '保存资源类型',
        'resourceTypeDestroy' => '删除资源类型',
        'bannerList' => '轮播列表',
        'bannerCreate' => '创建轮播',
        'bannerEdit' => '保存轮播',
        'bannerDestroy' => '删除轮播',
