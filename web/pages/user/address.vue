          ...
          <div class="item-on">
            <div class="address-info">
              ...
              <div class="address-action">
                <el-link type="danger" :underline="false" @click="defaultAddress(item)">设为默认</el-link>
                <el-link type="danger" :underline="false" @click="updateAddress(item)">修改</el-link>
                <el-link type="danger" :underline="false" @click="deleteAddress(item)">删除</el-link>
              </div>
            </div>
          </div>
        </div>
...
<script>
import { create, getList, edit, defaultSet, destroy } from '@/api/shipping'
export default {
  layout: 'user',
  head () {
    return {
