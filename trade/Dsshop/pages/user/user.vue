		...
		>
			...
			<view class="history-section icon">
				...
				<scroll-view scroll-x class="h-list">
					<image v-for="(item, index) in browseList" :key="index" @click="navTo('/pages/product/product?id=' + item.good_id)" :src="item.good.resources.img" mode="aspectFill" :class="(item.good.is_deleted==1 || item.good.is_show==0)?'gray-item':''" lazy-load></image>
				</scroll-view>
