<template>
  <div class="app-container">
    <div class="detailColTitle"><p>{{ $t('good.detail.name') }}</p></div>
    <div class="detailColValue"><p class="detailColDetail">{{ temp.name }}</p></div>
    <div class="detailColTitle"><p>{{ $t('good.detail.keypoint') }}</p></div>
    <div class="detailColValue"><p class="detailColDetail">{{ temp.keypoint }}</p></div>
    <div class="detailColTitle"><p>{{ $t('good.detail.master_shape') }}</p></div>
    ...
    <div class="detailColTitle"><p>{{ $t('good.detail.image_list') }}</p></div>
    ...
    <div class="detailColTitle"><p>{{ $t('good.detail.details') }}</p></div>
    <div class="detailColValue">
