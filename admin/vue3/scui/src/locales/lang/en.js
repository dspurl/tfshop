export default {
	general: {
		...
		confirmDeleteProject:
			"Are you sure to delete the selected {length} item?",
	...
	filterBar: {
		...
		index: {
			...
			prompt: {
				...
				inputPlaceholder:
					"Enter a common filter name with high recognition",
	...
	user: {
		...
		theme: "Theme colors",
		nightmodeMsg: "Suitable for low light environment",
		language: "language",
		form: {
			name: "Account",
			nameMsg:
				"The account information is used for login and cannot be modified",
			cellphone: "Cellphone",
			email: "Email",
			realName: "Real name",
		},
