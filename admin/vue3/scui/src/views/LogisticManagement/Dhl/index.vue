		...
		<el-container>
			<el-header>
				<div class="left-panel">
					<el-button v-auths="['DhlCreate']" type="primary" icon="el-icon-plus" @click="add"></el-button>
					<el-button
						v-auths="['DhlDestroy']"
						type="danger"
						plain
					...
					<el-table-column :label="$t('general.operation')" fixed="right" align="right" min-width="120">
						<template #default="scope">
							<el-button-group>
								...
								>
									<template #reference>
										<el-button v-auths="['DhlDestroy']" link type="primary" size="small">{{ $t('general.delete') }}</el-button>
									</template>
								</el-popconfirm>
							</el-button-group>
						</template>
