                ...
                <div class="item-info">
                  ...
                  <div class="tag">
                    <template v-if="search.activeIndex === '2'">
                      <el-tag v-if="item.state === 1" type="success" size="small" effect="dark">已下载</el-tag>
                      <el-tag v-else-if="item.state === 2" size="small" effect="dark">已安装</el-tag>
                      <el-tag
                        ...
                        effect="dark"
                      >已卸载</el-tag>
                      <el-tag v-else type="info" size="small" effect="dark">未下载</el-tag>
                    </template>
                    <el-tag v-if="item.local" class="right" type="info" size="small">本地</el-tag>
                  </div>
                  ...
                  <template v-if="search.activeIndex === '1'">
                    <template v-if="item.local">
                      ...
                      <el-popconfirm
                        ...
                        @confirm="handleDelete(item.abbreviation)"
                      >
                        <template #reference>
                          <el-button
                            :loading="formLoading"
