<template>
	<el-card shadow="hover" header="欢迎">
		<div class="welcome">
			...
			<div class="actions">
				<el-button type="primary" icon="el-icon-check" size="large" @click="goWebsite">官网</el-button>
				<el-button type="primary" icon="el-icon-check" size="large" @click="goGitHubDoc">GitHub</el-button>
			</div>
		</div>
	</el-card>
</template>
...
<script>
	export default {
		...
		methods: {
			goWebsite(){
				window.open("https://www.dswjcms.com")
			},
			goGitHubDoc(){
				window.open("https://github.com/dspurl/tfshop")
			}
		}
	}
</script>
