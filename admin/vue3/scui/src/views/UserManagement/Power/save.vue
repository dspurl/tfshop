				...
				>
					...
					<el-form-item :label="$t('power.form.type.name')" prop="type">
						<el-radio-group v-model="form.type">
							<el-radio-button :value="1">{{$t('power.form.type.label.menu')}}</el-radio-button>
							<el-radio-button :value="2">{{$t('power.form.type.label.iframe')}}</el-radio-button>
							<el-radio-button :value="3">{{$t('power.form.type.label.link')}}</el-radio-button>
							<el-radio-button :value="4">{{$t('power.form.type.label.button')}}</el-radio-button>
							<el-radio-button :value="5">{{$t('power.form.type.label.page')}}</el-radio-button>
						</el-radio-group>
					</el-form-item>
					...
					<el-form-item>
						<el-button v-auths="['PowerEdit']" type="primary" @click="save" :loading="loading">{{$t('general.save')}}</el-button>
					</el-form-item>
				</el-form>
			</el-col>
		</template>
