	...
	>
		...
		>
			...
			<el-form-item :label="$t('admin.form.portrait.name')" prop="portrait">
				<sc-icon-select v-model="form.portrait"></sc-icon-select>
			</el-form-item>
			...
			<el-form-item :label="$t('admin.form.state.name')" prop="state">
				<el-radio-group v-model="form.state">
					<el-radio value="1">{{ $t('admin.form.state.label.normal') }}</el-radio>
					<el-radio value="2">{{ $t('admin.form.state.label.forbid') }}</el-radio>
				</el-radio-group>
			</el-form-item>
		</el-form>
		<template #footer>
