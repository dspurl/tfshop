		...
		<el-header>
			...
			<div class="right-panel">
				<div class="right-panel-search" @keyup.enter="login">
					<el-input v-model="params.keyword" :placeholder="$t('resource_type.keyword')" clearable></el-input>
		...
		<el-main class="nopadding">
			...
			>
				...
				<template #uuid="scope">
					...
					<el-icon v-copy="scope.row.uuid">
						<component :is="'el-icon-document-copy'" />
					</el-icon>
				</template>
				<template #alias="scope">
					<span>{{scope.row.alias}}</span>
					<el-icon v-copy="scope.row.alias">
						<component :is="'el-icon-document-copy'" />
					</el-icon>
				</template>
				<template #icon="scope">
