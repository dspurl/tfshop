<template>
	<el-main style="padding:0 20px;" v-loading="loading">
		<el-card v-if="data.url" shadow="never" style="margin-bottom: 20px;">
			...
			<div v-if="!_isImg(data.url)" class="img-box">
				<sc-upload
					@del="coverDel"
					@succeed="cover"
		...
		<el-card shadow="never" style="margin-bottom: 20px;">
			<el-descriptions title="基础信息" size="medium" :column="2">
				<el-descriptions-item label="资源名称：">{{ data.name }}</el-descriptions-item>
				<el-descriptions-item label="资源别名：">{{ data.depict ? data.depict : '无' }}</el-descriptions-item>
			...
			<el-descriptions title="资源信息" size="medium" :column="2">
